...
--  musicwidget.font = "snap 10" -- Set widget font 
  musicwidget.scrolling = true -- If true, the text in the widget will be scrolled
  musicwidget.output_size = 50 -- Set the size of widget in symbols
  musicwidget.update_interval = 10 -- Set the update interval in seconds
  -- Set the folder where icons are located (change username to your login name)
  musicwidget.path_to_icons = "/home/rich/.config/awesome/awesompd/icons" 
  ...
  musicwidget.mpd_config = "/home/rich/.mpd/mpd.conf"
...
mytextclock = awful.widget.textclock("%a %b %e, %I:%M")
...
-- --   left_graphbox:add(downwidget)
   ...
   right_graphbox:add(musicwidget.widget)
...
-- --   right_graphbox:add(space)
   ...
   mygraphbox:set_widget(graphbox_layout)
-- -- }}}
...
globalkeys = awful.util.table.join(
 ...
 --{{{ Applications
  ...
  awful.key({ modkey, "Shift"     }, "p", function () exec("urxvt -depth 24 -e ranger /home/rich/Pictures") end),
  --awful.key({ modkey }, "l", function () exec("emacsclient /home/rich/Dropbox/org/lucas.org") end),
  --}}}
